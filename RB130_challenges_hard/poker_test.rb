...
class PokerTest < Minitest::Test
  ...
  def test_two_double_pair_with_same_high_pair
    # skip
    double_pair_2_and_8 = %w(2S 8H 2S 8D JH)
    double_pair_4_and_8 = %w(4S 5H 4S 8D 8H)
    game = Poker.new([double_pair_2_and_8, double_pair_4_and_8])
    assert_equal [double_pair_4_and_8], game.best_hand
  end
end